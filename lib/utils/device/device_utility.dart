...
class TDeviceUtils {
  //   ElevatedButton(
  //   onPressed: () {
  //     TDeviceUtils.hideKeyboard(context); // Close keyboard
  //     // Then submit form
  //   },
  //   child: Text('Submit'),
  // )
  ...
  static void hideKeyboard(BuildContext context) {
    // It removes focus from the currently focused widget (like a TextField) by giving focus to a new, empty FocusNode.
    // As a result, the keyboard is dismissed.
